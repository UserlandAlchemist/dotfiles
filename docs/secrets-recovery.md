...
gpg --armor --export shaun@lewisonline.xyz > /mnt/keyusb/pgp/shaun_public.asc
gpg --armor --export-secret-keys shaun@lewisonline.xyz > /mnt/keyusb/pgp/shaun_private.asc
gpg --output /mnt/keyusb/pgp/shaun_revocation.asc --gen-revoke shaun@lewisonline.xyz
```
...
gpg --import /mnt/keyusb/pgp/shaun_public.asc
gpg --import /mnt/keyusb/pgp/shaun_private.asc
```
...
gpg --edit-key shaun@lewisonline.xyz
gpg> trust
# select 5 = ultimate, confirm, then:
gpg> quit
```
...
│   ├── shaun_public.asc                # Public PGP key (shaun)
│   ├── shaun_private.asc               # Private PGP key (shaun)
│   └── shaun_revocation.asc            # Revocation cert (shaun)
├── tokens/
│   ├── jellyfin/
