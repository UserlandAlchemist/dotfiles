...
The output should include "Sending WOL to Astute..."
The output should include "Waiting for repository to become available..."
The stderr should include "ERROR: Astute not ready after WOL"
End
End
